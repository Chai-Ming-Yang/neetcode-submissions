...
class LRUCache:
    ...
    def get(self, key: int) -> int:
        print(f"GET ({key})   : {self.k}, ({self.lru.next.key}, {self.lru.next.val}), ({self.lru.prev.key}, {self.lru.prev.val})")
    ...
    def put(self, key: int, value: int) -> None:
        print(f"PUT ({key},{value}) : {self.k}, ({self.lru.next.key}, {self.lru.next.val}), ({self.lru.prev.key}, {self.lru.prev.val})")
        # if self.hashmap.get(key) and value == self.get(key):
        #     return
